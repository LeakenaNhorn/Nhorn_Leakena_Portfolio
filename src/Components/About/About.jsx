  ...
  return (
    <div id='about' className='about' >
        ...
        <div className='describe'>
          <p>I am an experienced Frontend Developer with over a decade of professional <br /> expertise in the field.Throughout my career, I have had the privilege of collaborating <br /> with prestigious organizations, contributing to their success and growth.</p>
